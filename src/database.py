...
from sqlalchemy import create_engine, Column, Integer, String, Boolean, ForeignKey, Date, DateTime, Table
...
class User(Base):
    ...
    shared_tasks = relationship('Task', secondary=task_shares, back_populates='shared_with_users')
...
class Task(Base):
    ...
    shared_with_users = relationship('User', secondary=task_shares, back_populates='shared_tasks')
